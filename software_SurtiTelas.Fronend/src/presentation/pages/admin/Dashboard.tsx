...
export const AdminDashboard: React.FC = () => {
  ...
  const loadDashboard = useCallback(async () => {
    if (!canFetchDashboard) {
      setError('No tienes permisos para visualizar estas métricas.');
      setLoading(false);
      return;
    }
      ...
      {!canViewPage && (
        <div className={s.errorState}>
          <div className={s.errorCard}>
            ...
            <h2 className={s.errorTitle}>No autorizado</h2>
            <p className={s.errorText}>No tienes permisos para acceder al dashboard de administración.</p>
